...
--
-- Client: localhost
-- Généré le: Mer 27 Avril 2016 à 16:18
...
CREATE TABLE IF NOT EXISTS `notification` (
  ...
  `statut_notification` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `texte` (`texte`),
  KEY `id_user` (`id_user`)
...
INSERT INTO `notification` (`id`, `id_user`, `texte`, `statut_notification`) VALUES
(1, 1, 'test 2', 0),
(2, 1, 'test1', 0),
(3, 2, 'Tache terminé', 0);
...
(2, 'Insertion table', 1, 20, 0, '2016-04-05', 1, 1),
