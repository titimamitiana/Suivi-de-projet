   ...
   <div class="container">
      <h4><a href="<?php echo(URL.'mes_projets/'); ?>" > Mes Projets</a> > 
         <a href="<?php echo(URL.'mes_projets/modules/'.$infos_user['id'].'/'); ?>" > <?php echo $module['nom_projet'] ?></a> > <?php echo $module['nom_module'] ?>  
      </h4>
      <h3>Taches :</h3>
      <br />
   ...
   <!-- End Bootstrap modal -->
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo(URL.'mes_projets/ajax_list_tache/'.$module['id'])?>",
                "type": "POST"
            },
    ...
    function edit_mes_projets_tache(id) {
        ...
        $.ajax({
            url: "<?php echo(URL.'mes_projets/ajax_edit_tache/')?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function delete_mes_projets_tache(id) {
        if (confirm('Are you sure delete this data?')) {
            ...
            $.ajax({
                url: "<?php echo(URL.'mes_projets/ajax_delete_tache')?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data) {
    ...
    $("#form").submit(function(e) {
        ...
        var url;
        if (save_method == 'add') {
            url = "<?php echo(URL.'mes_projets/ajax_add_tache/'.$module_id)?>";
        } else {
            url = "<?php echo(URL.'mes_projets/ajax_update_tache')?>";
        }
